<head>
  ...
  <link href="./assets/css/motos.css" rel="stylesheet" />
...
<body style="background: #102949;">
    ...
    <div class="container-fluid ">
      ...
      <div class="collapse navbar-collapse" id="navbarSupportedContent" style="font-size: 20px;">
        <ul class="navbar-nav me-auto mb-2 mb-lg-0">
          ...
          <li class="nav-item mx-0 mx-lg-1"><a class="nav-link py-3 px-0 px-lg-3 rounded" href="#about">Asccesosrios</a></li>
  ...
  <div class="row row-cols-1 row-cols-md-3 g-4 mt-5 pt-5" >
    <div class="col">
      <div class="card">
        <img src="./assets/img/adventure/8.png" class="card-img-top" alt="..." style="height: 290px;">
        <div class="card-body">
          <h5 class="card-title">$ 29,000.00</h5>
          <a href="#">
    ...
    <div class="col">
      <div class="card">
        <img src="./assets/img/adventure/2.png" class="card-img-top" alt="...">
        <div class="card-body">
          <h5 class="card-title">$ 110,000.00</h5>
          <a href="#">
            <p class="card-text">Ver mas</p>
          </a>
        </div>
    ...
    <div class="col">
      <div class="card">
        <img src="./assets/img/adventure/3.png" class="card-img-top" alt="...">
        <div class="card-body">
          <h5 class="card-title">$ 150,000.00</h5>
          <a href="#">
            <p class="card-text">Ver mas</p>
          </a>
        </div>
    ...
    <div class="col">
      <div class="card">
        <img src="./assets/img/adventure/4.png" class="card-img-top" alt="...">
        <div class="card-body">
          <h5 class="card-title">$ 190,000.00</h5>
          <a href="#">
            <p class="card-text">Ver mas</p>
          </a>
        </div>
    ...
    <div class="col">
      <div class="card">
        <img src="./assets/img/adventure/5.png" class="card-img-top" alt="...">
        <div class="card-body">
          <h5 class="card-title">$ 210,000.00</h5>
          <a href="#">
            <p class="card-text">Ver mas</p>
          </a>
        </div>
    ...
    <div class="col">
      <div class="card">
        <img src="./assets/img/adventure/6.png" class="card-img-top" alt="...">
        <div class="card-body">
    ...
    <div class="col">
      <div class="card">
        <img src="./assets/img/adventure/7.png" class="card-img-top" alt="...">
        <div class="card-body">
          <h5 class="card-title">$ 27,000.00</h5>
          <a href="#">
            <p class="card-text">Ver mas</p>
          </a>
        </div>
    ...
    <div class="col">
      <div class="card">
        <img src="./assets/img/adventure/8.png" class="card-img-top" alt="...">
        <div class="card-body">
          <h5 class="card-title">$ 33,000.00</h5>
          <a href="#">
            <p class="card-text">Ver mas</p>
          </a>
        </div>
    ...
    <div class="col">
      <div class="card">
        <img src="./assets/img/adventure/9.png" class="card-img-top" alt="...">
        <div class="card-body">
          <h5 class="card-title">$ 27,000.00</h5>
          <a href="#">
            <p class="card-text">Ver mas</p>
