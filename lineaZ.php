...
<nav class="navbar navbar-expand-lg navbar-light fixed-top" style="background: #727875;">
  ...
  <div class="col">
    <div class="card">
      <img src="./assets/img/lineaZ/9.png" class="card-img-top" alt="...">
      <div class="card-body">
  ...
  <div class="col">
    <div class="card">
      <img src="./assets/img/lineaZ/8.png" class="card-img-top" alt="...">
      <div class="card-body">
      <h5 class="card-title">$ </h5>
          <p class="card-text"></p></div>
    </div>
  ...
  <div class="col">
    <div class="card">
      <img src="./assets/img/lineaZ/7.png" class="card-img-top" alt="...">
      <div class="card-body">
      <h5 class="card-title">$ </h5>
          <p class="card-text"></p></div>
    </div>
  ...
  <div class="col">
    <div class="card">
      <img src="./assets/img/lineaZ/6.png" class="card-img-top" alt="...">
      <div class="card-body">
      <h5 class="card-title">$ </h5>
          <p class="card-text"></p></div>
    </div>
  ...
  <div class="col">
    <div class="card">
      <img src="./assets/img/lineaZ/5.png" class="card-img-top" alt="...">
      <div class="card-body">
      <h5 class="card-title">$ </h5>
          <p class="card-text"></p> </div>
    </div>
...
<div class="col">
    <div class="card">
      <img src="./assets/img/lineaZ/4.png" class="card-img-top" alt="...">
      <div class="card-body">
      <h5 class="card-title">$ </h5>
          <p class="card-text"></p></div>
    </div>
  ...
  <div class="col">
    <div class="card">
      <img src="./assets/img/lineaZ/3.png" class="card-img-top" alt="...">
      <div class="card-body">
      <h5 class="card-title">$ </h5>
          <p class="card-text"></p></div>
    </div>
  ...
  <div class="col">
    <div class="card">
      <img src="./assets/img/lineaZ/2.png" class="card-img-top" alt="...">
      <div class="card-body">
      <h5 class="card-title">$ </h5>
          <p class="card-text"></p>  </div>
    </div>
  ...
  <div class="col">
    <div class="card">
      <img src="./assets/img/lineaZ/1.png" class="card-img-top" alt="...">
      <div class="card-body">
      <h5 class="card-title">$ </h5>
          <p class="card-text"></p></div>
    </div>
